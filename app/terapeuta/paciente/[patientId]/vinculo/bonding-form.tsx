  ...
  return (
    <form action={handleSubmit} className="flex max-w-xl flex-col gap-4">
      <div className="flex gap-3">
        ...
        <div>
          <label className="text-xs font-medium uppercase tracking-wide text-ink-soft">Período · fim</label>
      ...
      <div>
        <label className="text-xs font-medium uppercase tracking-wide text-ink-soft">O que foi observado</label>
