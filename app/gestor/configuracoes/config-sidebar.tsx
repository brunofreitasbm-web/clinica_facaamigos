...
//
// "Usuários & Permissões" aponta direto pra /gestor/cadastros/colaboradores
// (10/09/2026, atualizado quando Colaboradores & Contas saiu do módulo
// Equipe e virou item de Cadastros). Antes apontava pra
// /gestor/configuracoes/usuarios, que é só um redirect server-side pra lá: o
// clique começava uma navegação pra Configurações e terminava em outra
// seção, sem aviso e com um round-trip a mais. A rota antiga continua
// redirecionando (compat de link salvo), mas saiu do caminho do clique — e
// o item ganha a marca de cross-link.
const SIDEBAR_ITEMS = [
  ...
  { key: "usuarios", label: "Usuários & Permissões", href: "/gestor/cadastros/colaboradores", external: true },
