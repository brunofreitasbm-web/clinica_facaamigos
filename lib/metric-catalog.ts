...
export const METRIC_CATALOG: Partial<Record<Role, MetricDef[]>> = {
  ...
  supervisor: [
    ...
    // anamnese. Ver countOverduePlans/listOverduePlans em lib/pts-pending.ts
  ...
  terapeuta: [
    ...
    { key: "data_collection_rate", label: "Coleta de dados por sessão", direction: "min", unit: "pct", computed: true },
    { key: "therapist_cancel_rate", label: "Cancelamento pelo terapeuta", direction: "max", unit: "pct", computed: true },
    ...
    { key: "attributable_glosa", label: "Glosa atribuível ao terapeuta", direction: "max", unit: "pct", computed: true },
  ],
  faturamento: [
    { key: "glosa_rate", label: "Glosa sobre faturado", direction: "max", unit: "pct", computed: true },
    { key: "glosa_recovery", label: "Recuperação de glosa", direction: "min", unit: "pct", computed: true },
    { key: "batch_lead_days", label: "Dias até exportar lote", direction: "max", unit: "dias", computed: true },
    { key: "dso_days", label: "Dias até o pagamento (DSO)", direction: "max", unit: "dias", computed: true },
    { key: "no_auth_sessions", label: "Sessões sem guia vigente", direction: "max", unit: "pct", eliminatory: true, computed: true },
  ],
};
