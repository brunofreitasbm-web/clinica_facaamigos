...
import { SUPERVISION_KB_DATA } from "@/lib/supervisao-knowledge-base-data";
import Link from "next/link";

/**
 * Conteúdo do drawer, carregado via next/dynamic (ssr: false) só quando
 * aberto — ver components/supervisao-knowledge-base-drawer.tsx.
 */
export function SupervisaoKnowledgeBasePanel({ onClose }: { onClose: () => void }) {
