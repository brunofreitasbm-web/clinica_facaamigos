...
import { THERAPIST_KB_DATA } from "@/lib/therapist-knowledge-base-data";
import Link from "next/link";

/**
 * Conteúdo do drawer, carregado via next/dynamic (ssr: false) só quando
 * aberto — ver components/therapist-knowledge-base-drawer.tsx.
 */
export function TherapistKnowledgeBasePanel({ onClose }: { onClose: () => void }) {
