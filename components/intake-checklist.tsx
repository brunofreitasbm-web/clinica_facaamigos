 ...
 * `links` aponta pra tela onde a etapa de fato acontece (1ª avaliação /
 * anamnese, equipe, reunião, PTS).
 *
...
export function IntakeChecklist({
  ...
  /**
   * Alguns `links` apontam pra fora de `/recepcao` (ex.: 1ª avaliação/anamnese, PTS e
