...
import { RECEPTION_KB_DATA } from "@/lib/knowledge-base-data";
import Link from "next/link";

/**
 * Conteúdo do drawer, carregado via next/dynamic (ssr: false) só quando
 * aberto — ver components/knowledge-base-drawer.tsx. Antes este componente
 * (+ os ~15KB de lib/knowledge-base-data.ts) ia no JS inicial de toda tela
 * de /recepcao mesmo fechado.
 */
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  <h2 className="text-lg font-bold tracking-tight text-white">Base de Conhecimento da Recepção</h2>
                ...
                <p className="text-xs text-slate-300">
                  Guia didático de processos, fluxos e procedimentos para a recepção da clínica
                </p>
              </div>
            </div>
            ...
            {activeArticle ? (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-200">
                ...
                <div className="bg-white rounded-2xl p-6 border border-slate-200 shadow-sm space-y-5">
                  ...
                  {/* Regras e Boas Práticas ("O que NUNCA fazer") */}
              ...
              <div className="space-y-6">
                <div className="bg-rose-950 text-white rounded-2xl p-5 border border-rose-900 shadow-sm space-y-2">
                  <h4 className="text-sm font-bold text-rose-200 uppercase tracking-wider flex items-center gap-2">
                    ...
                    Board Didático Operacional da Recepção
                  </h4>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="bg-rose-50 p-2.5 rounded-xl border border-rose-100 space-y-1">
                          <span className="text-[10px] font-bold text-rose-800 uppercase flex items-center gap-1">
                            <ShieldAlert className="h-3 w-3 text-rose-600" /> Recomendação:
                          </span>
